...
/** Marks that this method should be execute transactionally. Created by mwei on 3/29/16. */
...
public @interface TransactionalMethod {
  ...
  /**
   * The name of a function that calculates which streams will be affected as a result of this
