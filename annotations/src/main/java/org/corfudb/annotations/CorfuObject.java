...
/**
 * Marks an object which should exist in the Corfu log. Objects marked with the CorfuObject
 * annotation are targeted for instrumentation by the annotation processor. Created by mwei on
 * 3/30/16.
 */
