...
/**
 * Lets SMR objects define how they want to internally represent changes that are brought on by the
...
public interface ICorfuExecutionContext<T> {
  ...
  /**
   * Returns the underlying object T which has been prepared to execute under the specified context.
   *
   * <p>For the data-structures that do not care about different contexts, they should simply return
   * "this".
   *
