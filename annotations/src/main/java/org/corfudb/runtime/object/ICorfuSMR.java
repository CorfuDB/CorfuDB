 ...
 *
 * @param <T> The type of the underlying object. Created by mwei on 11/10/16.
 */
public interface ICorfuSMR<T>
  ...
  /**
   * Same as {@link ICorfuSMR#close()}. However this method calls close on the actual (wrapper)
   * object, and not the underlying one.
   */
  @DontInstrument
