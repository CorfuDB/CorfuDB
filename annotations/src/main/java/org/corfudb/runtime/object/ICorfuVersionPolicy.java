...
/**
 * This interface helps different Corfu components understand what type of versioning update scheme
 * the underlying object supports.
 */
public interface ICorfuVersionPolicy {

  /**
   * The default (non-monotonic) version update policy. This means that the object is allowed to
   * move back and forth in time.
   */
  VersionPolicy DEFAULT = new VersionPolicy();

  /** A more restrictive update policy that allows the object to only move forward in time. */
