 ...
 *
 * @param <T> The type of the SMR object. Created by mwei on 11/10/16.
 */
public interface ICorfuSMRProxy<T> {

  /**
   * Pass-through: invoke a method on the object without mutator/accessor synchronization.
   *
   ...
   * @param keepUpcallResult Whether or not we need to keep the result to the upcall, for a
   *     subsequent call to getUpcallResult.
   * @param conflictObject Fine-grained conflict information, if available.
   * @param args The arguments to the function.
   * @return The address in the log the SMR function was recorded at.
   */
  long logUpdate(
      String smrUpdateFunction, boolean keepUpcallResult, Object[] conflictObject, Object... args);
