...
Usage:
  corfu_add_node (-c <config>) (-n <endpoint>) [-e [-u <keystore> -f <keystore_password_file>] [-r <truststore> -w <truststore_password_file>] [-g -o <username_file> -j <password_file>]]
Options:
...
(defn add-node [endpoint]
      (println (.. (get-management-view) (addNode endpoint))))
