...
public class CorfuSequencerTask implements CorfuSequencer.Iface {
	...
	public void serverloop() {
        ...
        CorfuSequencer.Processor<CorfuSequencerTask> processor;
        System.out.println("run..");

        try {
            serverTransport = new TServerSocket(port);
            processor =
                    new CorfuSequencer.Processor<CorfuSequencerTask>(this);
