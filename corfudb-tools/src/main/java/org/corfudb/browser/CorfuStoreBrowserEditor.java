...
public class CorfuStoreBrowserEditor implements CorfuBrowserEditorCommands {
    ...
    public void insertReplicationGroupAndDestination(String clientName, String logicalGroup, List<String> remoteDestinations) {
        System.out.println("\n======================\n");
    ...
    public void deleteReplicationGroupAndDestination(String clientName, String logicalGroup) {
        System.out.println("\n======================\n");
