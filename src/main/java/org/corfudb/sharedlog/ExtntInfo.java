...
public class ExtntInfo implements org.apache.thrift.TBase<ExtntInfo, ExtntInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ExtntInfo> {
  ...
  public ExtntInfo() {
    this.flag = ExtntMarkType.EX_FILLED;
  ...
  public int compareTo(ExtntInfo other) {
    ...
    lastComparison = Boolean.valueOf(isSetMetaFirstOff()).compareTo(other.isSetMetaFirstOff());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMetaFirstOff()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.metaFirstOff, other.metaFirstOff);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetMetaLength()).compareTo(other.isSetMetaLength());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMetaLength()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.metaLength, other.metaLength);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
