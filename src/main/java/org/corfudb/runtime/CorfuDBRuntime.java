...
/**
 * This is used by SMREngine to wrap commands before serializing them in the streambundle,
...
class SMREngine
{
	...
	void playback()
	{
		...
		while(update!=null)
		{
			SMRCommandWrapper cmdw = (SMRCommandWrapper)update.getPayload().deserialize();
