...
public class NettyClientRouter extends SimpleChannelInboundHandler<NettyCorfuMsg> {
    ...
    public Map<NettyCorfuMsg.NettyCorfuMsgType, INettyClient> handlerMap;
     ...
     */
    public <T> CompletableFuture<T> sendMessageAndGetCompletable(ChannelHandlerContext ctx, NettyCorfuMsg message)
    {
     ...
     *                      or a timeout in the case there is no response.
     */
    public <T> CompletableFuture<T> sendMessageAndGetCompletable(NettyCorfuMsg message)
    {
     ...
     * @param message       The message to send.
     */
    public void sendMessage(ChannelHandlerContext ctx, NettyCorfuMsg message)
    {
     ...
     * @param message       The message to send.
     */
    public void sendMessage(NettyCorfuMsg message)
    {
        sendMessage(message);
    }
     ...
     */
    public boolean validateEpochAndClientID(NettyCorfuMsg msg, ChannelHandlerContext ctx)
    {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, NettyCorfuMsg m) throws Exception {
        try {
