...
public class LambdaUtils {
    ...
    private static Map<Class<Object>, LambdaResolver<Object>> generateDispatchMap() {
        ...
        typedPut(builder, BiConsumer.class, (f, a) -> {f.accept(a[0], a[1]); return null;});
        ...
        typedPut(builder, Consumer.class, (f, a) -> {f.accept(a[0]); return null;});
        typedPut(builder, DoubleBinaryOperator.class, (f, a) -> f.applyAsDouble((double)a[0], (double)a[1]));
        typedPut(builder, DoubleConsumer.class, (f, a) -> {f.accept((double)a[0]); return null;});
        ...
        typedPut(builder, IntConsumer.class, (f, a) -> {f.accept((int)a[0]); return null;});
        ...
        typedPut(builder, LongConsumer.class, (f, a) -> {f.accept((long)a[0]); return null;});
        ...
        typedPut(builder, ObjDoubleConsumer.class, (f, a) -> {f.accept(a[0], (double)a[1]); return null;});
        typedPut(builder, ObjIntConsumer.class, (f, a) -> {f.accept(a[0], (int)a[1]); return null;});
        typedPut(builder, ObjLongConsumer.class, (f, a) -> {f.accept(a[0], (long)a[1]); return null;});
