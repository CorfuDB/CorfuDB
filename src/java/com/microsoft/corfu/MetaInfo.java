...
public class MetaInfo implements org.apache.thrift.TBase<MetaInfo, MetaInfo._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MetaInfo");
  ...
  static {
    schemes.put(StandardScheme.class, new MetaInfoStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MetaInfoTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MetaInfo.class, metaDataMap);
  }
  ...
  public MetaInfo setMetaFirstOff(long metaFirstOff) {
    this.metaFirstOff = metaFirstOff;
    setMetaFirstOffIsSet(true);
    return this;
  }
  ...
  public MetaInfo setMetaLastOff(long metaLastOff) {
    this.metaLastOff = metaLastOff;
    setMetaLastOffIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MetaInfo)
      return this.equals((MetaInfo)that);
    return false;
  }

  public boolean equals(MetaInfo that) {
    if (that == null)
      return false;
  ...
  public int compareTo(MetaInfo other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    MetaInfo typedOther = (MetaInfo)other;
  ...
  private static class MetaInfoStandardSchemeFactory implements SchemeFactory {
    public MetaInfoStandardScheme getScheme() {
      return new MetaInfoStandardScheme();
    }
  }

  private static class MetaInfoStandardScheme extends StandardScheme<MetaInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MetaInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MetaInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class MetaInfoTupleSchemeFactory implements SchemeFactory {
    public MetaInfoTupleScheme getScheme() {
      return new MetaInfoTupleScheme();
    }
  }

  private static class MetaInfoTupleScheme extends TupleScheme<MetaInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MetaInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MetaInfo struct) throws org.apache.thrift.TException {
