...
/**
 * An app to dump the MBean object names and their corresponding attributes into disk. it uses JVM
 * flags: corfu.jmx.service.url, dump.domains, dump.file to correspondingly determine JMX server's
 * service URL, the domains for which to retrieve the MBeans and their attributes, and the file to
 * export the results.
 *
 * <p>Created by Sam Behnam on 3/30/18.
 */
public class MBeanDumperApp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    final String[] domains =
        (domainsArg == null || domainsArg.length() == 0) ? new String[0] : domainsArg.split(",");
