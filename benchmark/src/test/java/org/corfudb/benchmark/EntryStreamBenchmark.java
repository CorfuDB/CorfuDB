...
public class EntryStreamBenchmark extends GenericIntegrationTest {
    ...
    public static void main(String[] args) throws RunnerException {
        for (int threads = minThreadCount; threads <= maxThreadCount; threads = threads * 2) {
            ...
            Options opt = new OptionsBuilder()
                    .include(EntryStreamBenchmark.class.getSimpleName())
                    //.verbosity(SILENT)
                    .addProfiler("gc")
                    .forks(1)
                    .threads(threadCount)
    ...
    public void setup(BenchmarkState state) throws
        ...
        universeManager = UniverseManager.builder()
                .testName(EntryStreamBenchmark.class.getSimpleName())
