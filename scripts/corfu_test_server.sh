...
#export JACOCO="-javaagent:/Users/huaca/.m2/repository/org/jacoco/org.jacoco.agent/0.8.8/org.jacoco.agent-0.8.8-runtime.jar=output=tcpclient,address=127.0.0.1,port=6300,append=true,sessionid=corfuserver,includes=*"
export JACOCO="-javaagent:${MVN_PATH}/org/jacoco/org.jacoco.agent/0.8.8/org.jacoco.agent-0.8.8-runtime.jar=destfile=${DIR}/../infrastructure/target/jacoco-corfu-server.exec"

$JAVA $JACOCO -cp "$CLASSPATH" $JVMFLAGS org.corfudb.infrastructure.CorfuServer $*
