...
class Wizard(object):
    ...
    def _run_corfu_compactor(self):
        ...
        if self._config.upgrade:
            ...
            grep_running_tool = "ps aux | grep 'python3 /usr/share/corfu/scripts/compactor_runner_as_corfu.py\|corfu_compactor_upgrade_runner.py' | grep 'bin\/sh' | grep -v 'grep' | grep " + self._config.corfu_port
