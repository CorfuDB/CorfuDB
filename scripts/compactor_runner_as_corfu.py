...
class Wizard(object):
    ...
    def _run_corfu_compactor(self):
        ...
        self._print_and_log("Invoked compactor runner")
        ...
        if self._config.upgrade:
            ...
            grep_running_tool = "ps aux | grep 'python3 /usr/share/corfu/scripts/compactor_runner.py\|corfu_compactor_upgrade_runner.py' | grep -v 'grep' | grep " + self._config.corfu_port
