...
/**
 * Provides executable commands for the CorfuServer-s to create a directory structure, copy a corfu
 * server jar file from the source to the target directory, to manage corfu server (start, stop,
 * kill)
 */
@Slf4j
public class CorfuProcessManager {

  @NonNull private final CorfuServerParams params;
