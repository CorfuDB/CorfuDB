...
public class ClientParams implements NodeParams {
  ...
  @Default @NonNull private final String name = "corfuClient";

  @NonNull private final NodeType nodeType = NodeType.CORFU_CLIENT;

  @Default @Getter private final int port = ServerUtil.getRandomOpenPort();

  /** Total number of times to retry a workflow if it fails */
  @Default @NonNull @EqualsAndHashCode.Exclude private final int numRetry = 5;
  ...
  @Default @EqualsAndHashCode.Exclude private final int order = 0;
