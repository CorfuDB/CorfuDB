...
public abstract class AbstractCorfuServer<T extends CorfuServerParams, U extends UniverseParams>
  ...
  @NonNull protected final T params;
  ...
  protected AbstractCorfuServer(
      @NonNull T params, @NonNull U universeParams, @NonNull LoggingParams loggingParams) {
    this.params = params;
  ...
  protected String getCommandLineParams() {
    ...
    cmd.append(" --log-size-quota-percentage=")
        .append(params.getLogSizeQuotaPercentage())
        .append(" ");
