...
public abstract class AbstractCluster<
        T extends Node, N extends NodeParams, P extends GroupParams<N>, U extends UniverseParams>
    implements Cluster<T, P> {

  @Getter @NonNull protected final P params;

  @NonNull protected final U universeParams;
        ...
        .forEach(
            node -> {
              try {
                ...
                log.warn(
                    "Can't stop node: {} in group: {}",
                    node.getParams().getName(),
                    getParams().getName(),
                    e);
              }
            });
