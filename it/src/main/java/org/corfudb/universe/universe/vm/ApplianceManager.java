...
/** Managing vm appliances: deploy vm's, stop, restart, destroy. Keeps list of vm's */
@Builder
@Slf4j
public class ApplianceManager {
  ...
  public void deploy() {
    ...
    universeParams.getVmIpAddresses().keySet().stream()
        ...
        () -> {
          try {
            ...
            Credentials vSphereCredentials =
                universeParams.getCredentials().getVSphereCredentials();
