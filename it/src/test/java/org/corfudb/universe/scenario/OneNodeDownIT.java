...
public class OneNodeDownIT extends GenericIntegrationTest {
   ...
   *
   * <p>1) Deploy and bootstrap a three nodes cluster 2) Stop one node 3) Verify layout, cluster
   * status and data path 4) Recover cluster by restarting the stopped node 5) Verify layout,
  ...
  private void oneNodeDown(UniverseWorkflow<Fixture<UniverseParams>> wf)
