...
public class OneLinkFailureIT extends GenericIntegrationTest {
    ...
    public void oneLinkFailureTest() {
        workflow(wf -> {
            ...
            final DockerCorfuServer firstServer = (DockerCorfuServer) corfuCluster1.getFirstServer();
            firstServer.introduceDelay(1000);
            Sleep.sleepUninterruptibly(Duration.ofSeconds(60));
            System.out.println("Remove delay");
            firstServer.removeDelay();
            Sleep.sleepUninterruptibly(Duration.ofSeconds(60));
