...
public class OneNodePausedIT extends GenericIntegrationTest {
   ...
   *
   * <p>1) Deploy and bootstrap a three nodes cluster 2) Pause one node (hang the jvm process) 3)
   * Verify layout, cluster status and data path 4) Recover cluster by resuming the paused node 5)
   * Verify layout, cluster status and data path again
   */
  @Test(timeout = 300000)
