...
public class ConcurrentClusterResizeIT extends GenericIntegrationTest {
   ...
   *
   * <p>1) Deploy and bootstrap a five nodes cluster 2) Concurrently remove four nodes from cluster
   * 3) Verify layout and data path 4) Concurrently add four nodes back into cluster 5) Verify
   * layout and data path again
   */
  @Test(timeout = 600000)
