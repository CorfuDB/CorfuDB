...
/**
 * Common parent class for all universe tests. Each test should extend GenericIntegrationTest class.
 * The class provides the initialization steps, it creates UniverseManager that is used to provide a
 * universe framework workflow to manage your initialization and deployment process in the universe.
 */
