...
public class LogUnitServerAssertions
    extends AbstractAssert<LogUnitServerAssertions, LogUnitServer> {
  ...
  public LogUnitServerAssertions matchesDataAtAddress(long address, Object data) {
    ...
    if (actual.getDataCache().get(address) == null) {
      ...
      org.assertj.core.api.Assertions.assertThat(
              ((LogData) actual.getDataCache().get(address)).getData())
          .isEqualTo(expected);
    }
  ...
  public LogUnitServerAssertions hasMaxCorrectCacheSize(double ratio) {
    ...
    if (actual.getMaxCacheSize() != (long) (maxHeapSize * ratio)) {
      failWithMessage(
          "Expected cache size <%d> doesn't match allocated cache size <%d>",
