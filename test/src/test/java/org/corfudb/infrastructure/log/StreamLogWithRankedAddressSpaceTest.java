...
public class StreamLogWithRankedAddressSpaceTest extends AbstractCorfuTest {
  ...
  private void writeToLog(
      StreamLog log, long address, DataType dataType, String payload, long rank) {
    this.writeToLog(log, address, dataType, payload, new IMetadata.DataRank(rank));
  }

  private void writeToLog(
      StreamLog log, long address, DataType dataType, String payload, IMetadata.DataRank rank) {
