...
/**
 * Tests the failure handling : Sealing and updating layout depending upon the trigger. Created by
 * zlokhandwala on 11/18/16.
 */
public class ReconfigurationEventHandlerTest extends AbstractViewTest {
  ...
  public void updateLayoutOnFailure() {
    ...
    reconfigurationEventHandler.handleFailure(
        failureHandlerPolicy, originalLayout, corfuRuntime, failedServers);
