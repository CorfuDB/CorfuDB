...
public class TestServerRouter implements IServerRouter {
  ...
  @Getter public List<CorfuMsg> responseMessages;

  @Getter public Map<CorfuMsgType, AbstractServer> handlerMap;

  @Getter public ArrayList<AbstractServer> servers;

  public List<TestRule> rules;

  AtomicLong requestCounter;

  @Getter long serverEpoch;

  @Setter @Getter ServerContext serverContext;
