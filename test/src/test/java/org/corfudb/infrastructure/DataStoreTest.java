...
public class DataStoreTest extends AbstractCorfuTest {
  ...
  private DataStore createPersistDataStore(
      String serviceDir, String numRetention, Consumer<String> cleanupTask) {
  ...
  private DataStore createInMemoryDataStore() {
    return new DataStore(
        new ImmutableMap.Builder<String, Object>().put("--memory", true).build(), fn -> {});
  }
