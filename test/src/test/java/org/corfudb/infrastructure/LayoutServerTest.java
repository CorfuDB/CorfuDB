...
public class LayoutServerTest extends AbstractServerTest {
    ...
    public void testChangeEpochInPhase2ByBaseServer() {
        ...
        Assertions.assertThat(spyLayoutServer.getPhase2Data(newSealEpoch))
                .isNull();
        // Make sure data has been accepted for the correct epoch.
        Assertions.assertThat(spyLayoutServer.getPhase2Data(newLayout.getEpoch()))
                .isNotNull();
    }
