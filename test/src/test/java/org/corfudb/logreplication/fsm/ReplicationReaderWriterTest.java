...
public class ReplicationReaderWriterTest extends AbstractViewTest {
    ...
    /*
     * store message generated by streamsnapshot logreader and will play it at the writer side.
     */
    ...
    public void setup() {
        ...
        LogReplicationMetadata logReplicationMetadata = new LogReplicationMetadata(readerRuntime, 0, uuid, uuid);
        logEntryReader = new StreamsLogEntryReader(readerRuntime, config);
        logEntryWriter = new LogEntryWriter(writerRuntime, config, logReplicationMetadata);
    }
    ...
    void writeMsgs(List<LogReplicationEntry> msgQ, Set<String> streams, CorfuRuntime rt) {
        UUID uuid = UUID.randomUUID();
        LogReplicationConfig config = new LogReplicationConfig(streams, PRIMARY_SITE_ID, REMOTE_SITE_ID);
        LogReplicationMetadata logReplicationMetadata = new LogReplicationMetadata(rt, 0, uuid, uuid);
