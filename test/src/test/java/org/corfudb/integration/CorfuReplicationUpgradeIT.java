...
public class CorfuReplicationUpgradeIT extends LogReplicationAbstractIT {
    ...
    // restart or init.  1 update for each remote source cluster(3 total) on init + NUM_SNAPSHOT_SYNC_UPDATES_ON_SINK_STATUS_TABLE
    private static final int TOTAL_SINK_STATUS_ENTRIES_INIT_SNAPSHOT_SYNC =
        3 + NUM_SNAPSHOT_SYNC_UPDATES_ON_SINK_STATUS_TABLE;
