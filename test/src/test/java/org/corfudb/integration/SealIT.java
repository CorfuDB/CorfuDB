...
public class SealIT extends AbstractIT{
    ...
    public void RuntimeWithWrongEpochGetUpdated() throws Exception {
        ...
        Long beforeAddress = cr2.getSequencerView().next().getLogicalSequenceNumber().getSequenceNumber();
         ...
         */
        Long afterAddress = cr2.getSequencerView().next().getLogicalSequenceNumber().getSequenceNumber();
