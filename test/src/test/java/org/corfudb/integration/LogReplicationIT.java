...
public class LogReplicationIT extends AbstractIT implements Observer {
    ...
    void generateData(HashMap<String, CorfuTable<Long, Long>> tables,
        ...
        for (int i = 0; i < numKeys; i++) {
            for (String name : srcCorfuTables.keySet()) {
    ...
    public void testTwoIndependentCorfuServers() throws IOException {
        ...
        generateData(srcCorfuTables, srcDataForVerification, NUM_KEYS, srcDataRuntime, NUM_KEYS);

        // generate data at destinationServer
        generateData(dstCorfuTables, dstDataForVerification, NUM_KEYS, dstDataRuntime, NUM_KEYS*2);
