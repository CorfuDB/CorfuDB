...
public class LogReplicationIT extends AbstractIT implements Observer {
    ...
    // An Observable value on the number of errors received on Log Entry Sync
    ...
    public void testLogEntrySyncInvalidCrossTablesPartial() throws Exception {
        ...
        // Verify Destination
        verifyData(dstTables, partialSrcHashMap);
    }
    ...
    public void update(Observable o, Object arg) {
        if (o == ackMessages) {
            ...
            verifyErrors(errorsLogEntrySync.getValue());
        }
    }
