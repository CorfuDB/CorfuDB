...
public class CmdletIT extends AbstractIT {
    ...
    public void testCorfuSequencerCmdlet() throws Exception {
        ...
        String commandNextToken = CORFU_PROJECT_DIR + "bin/corfu_sequencer -i " + streamA + " -c " + ENDPOINT + " next-logicalSequenceNumber 3";
        runCmdletGetOutput(commandNextToken);

        LogicalSequenceNumber logicalSequenceNumber = runtime.getSequencerView()
                .query(CorfuRuntime.getStreamID(streamA)).getLogicalSequenceNumber();
        ...
        assertThat(output.contains(logicalSequenceNumber.toString())).isTrue();
        shutdownCorfuServer(corfuServerProcess);
    }
