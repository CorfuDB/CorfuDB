...
public class LogReplicationDynamicStreamIT extends LogReplicationAbstractIT {
    ...
    private void writeToMap(Table<StringKey, IntValue, Metadata> map, boolean isActive,
    ...
    private void verifyDataOnStandby(Table<StringKey, IntValue, Metadata> mapStandby,
    ...
    /**
     * We need to clear local writes on Sink for streams with is not MERGE_ONLY and received data during log replication.
     *
