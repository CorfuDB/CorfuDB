...
public class ClusterReconfigIT extends AbstractIT {
    ...
    private void addNewNode(String endpoint, CorfuRuntime runtime) throws Exception {

        runtime.getLayoutManagementView().bootstrapNewNode(endpoint);
        runtime.getLayoutManagementView()
                .addNode((Layout) runtime.getLayoutView().getCurrentLayout().clone(),
                        endpoint,
                        true,
                        true,
                        true,
        ...
        Layout setupReplicaLayout = (Layout) runtime.getLayoutView().getCurrentLayout().clone();

        runtime.getLayoutManagementView()
                .stateTransfer(endpoint, setupReplicaLayout.getSegment(0));
        runtime.getLayoutManagementView().mergeSegments(setupReplicaLayout);
    }
    ...
    public void addNodesTest() throws Exception {
        ...
        addNewNode("localhost:9001", runtime);
        addNewNode("localhost:9002", runtime);
