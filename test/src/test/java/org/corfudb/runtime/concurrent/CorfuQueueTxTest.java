...
public class CorfuQueueTxTest extends AbstractTransactionsTest {
  ...
  /**
   * This concurrent test validates that the CorfuQueue::enqueue operations are ordered by that of
   * the parent transaction and fail if transaction aborts.
   *
   * @throws Exception
   */
  @Test
  ...
  public void queueOrderedByTransaction(TransactionType txnType) throws Exception {
    ...
    CorfuQueue<String> corfuQueue = new CorfuQueue<>(getRuntime(), "testQueue");
    class Record {
      @Getter public CorfuRecordId id;
    ...
    CorfuQueue<String> corfuQueue2 = new CorfuQueue<>(getRuntime(), "testQueue");
    ...
    assertThat(backToRecId.getTxSequence())
        .isEqualTo(records.get(idx).getRecordId().getTxSequence());
  ...
  public void queueOutOfOrderedByTransaction(TransactionType txnType, boolean inOrder)
      throws Exception {
