...
/**
 * Validate that Corfu token based Guid Generator satisfies the following two criteria: 1. The guids
 * are unique. 2. The guids are monotonically increasing. Created by Sundar Sridharan on May 23,
 * 2019.
 */
public class CorfuGuidGeneratorTest extends AbstractViewTest {
  ...
  public void areUniqueAndOrderedLong() {
    ...
    CorfuGuidGenerator guidGenerator =
        CorfuGuidGenerator.getInstance(getDefaultRuntime().connect());
    long lastValue = 0;
