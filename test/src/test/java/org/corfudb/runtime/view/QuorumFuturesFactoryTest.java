...
/** Tests the futures used in the quorum replication Created by Konstantin Spirov on 2/6/2017. */
public class QuorumFuturesFactoryTest extends AbstractCorfuTest {
  ...
  public void test3FuturesIncompleteComplete() throws Exception {
    ...
    QuorumFuturesFactory.CompositeFuture<String> result =
        QuorumFuturesFactory.getQuorumFuture(String::compareTo, f1, f2, f3);
    try {
      result.get(PARAMETERS.TIMEOUT_VERY_SHORT.toMillis(), TimeUnit.MILLISECONDS);
      fail();
    } catch (TimeoutException e) {
  ...
  public void testFailFastExceptionSingle() throws Exception {
    ...
    QuorumFuturesFactory.CompositeFuture<String> result =
        QuorumFuturesFactory.getQuorumFuture(
            String::compareTo,
            new CompletableFuture[] {f1, f2, f3},
  ...
  public void testCanceledFromInside() throws Exception {
    CompletableFuture<String> f1 = new CompletableFuture<>();
    QuorumFuturesFactory.CompositeFuture<String> result =
        QuorumFuturesFactory.getQuorumFuture(String::compareTo, f1);
    f1.cancel(true);
    try {
      Object value = result.get(PARAMETERS.TIMEOUT_SHORT.toMillis(), TimeUnit.MILLISECONDS);
      fail();
  ...
  public void testCanceledPlusException() throws Exception {
    ...
    CompletableFuture<String> f2 = new CompletableFuture<>();
    QuorumFuturesFactory.CompositeFuture<String> result =
        QuorumFuturesFactory.getQuorumFuture(String::compareTo, f1, f2);
    f1.cancel(true);
