...
public class ObjectsViewTest extends AbstractViewTest {
  ...
  public void abortedTransactionDoesNotConflict() throws Exception {
    ...
    CorfuTable<String, String> mapCopy =
        getDefaultRuntime()
            .getObjectsView()
            .build()
            .setStreamName(mapA)
  ...
  public void incorrectNestingTest() {
    ...
    CorfuRuntime r2 =
        CorfuRuntime.fromParameters(
            CorfuRuntime.CorfuRuntimeParameters.builder().nettyEventLoop(NETTY_EVENT_LOOP).build());
    CorfuTable<String, String> map =
        getDefaultRuntime()
            .getObjectsView()
            .build()
    ...
    assertThatThrownBy(() -> r2.getObjectsView().TXBegin())
