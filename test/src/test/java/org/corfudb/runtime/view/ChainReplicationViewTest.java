...
public class ChainReplicationViewTest extends AbstractViewTest {
  ...
  public void canReadWriteToSingle() throws Exception {
    ...
    r.getAddressSpaceView()
        .write(
            new TokenResponse(
                new Token(runtime.getLayoutView().getLayout().getEpoch(), 0),
        ...
        threadNumber -> {
          ...
          for (int i = base; i < base + numberRecords; i++) {
            r.getAddressSpaceView()
                .write(
                    new TokenResponse(
                        new Token(runtime.getLayoutView().getLayout().getEpoch(), i),
  ...
  public void ensureAllUnitsContainData() throws Exception {
    ...
    r.getAddressSpaceView()
        .write(
            new TokenResponse(
                new Token(0, 0), Collections.singletonMap(streamA, Address.NO_BACKPOINTER)),
            testPayload);
