...
public class ObjectBuilderTest {
  ...
  /**
   * Make sure that the correct constructor is being used in case of constructor overloading.
   *
  ...
  public void constructorInterfaceMatching()
    ...
    ReflectionUtils.findMatchingConstructor(ExampleInterface.class.getDeclaredConstructors(), args);
  }

  /**
   * Make sure that the correct constructor is being used in case of a zero-arg constructor.
   *
   * @throws IllegalAccessException should not be thrown
   * @throws InstantiationException should not be thrown
   * @throws InvocationTargetException should not be thrown
