 ...
 *
 * <p>Created by zlokhandwala on 11/7/16.
 */
public class ManagementHandlerTest extends AbstractClientTest {
  ...
  Set<IClient> getClientsForTest() {
    ...
    client =
        new ManagementClient(router, 0L, UUID.fromString("00000000-0000-0000-0000-000000000000"));
   ...
   */
  @Test
  public void handleBootstrap() throws Exception {
