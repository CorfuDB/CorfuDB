...
public class LayoutHandlerTest extends AbstractClientTest {
  ...
  Set<AbstractServer> getServersForTest() {
    ...
    return new ImmutableSet.Builder<AbstractServer>().add(new LayoutServer(sc)).build();
  }
  ...
  Set<IClient> getClientsForTest() {
    ...
    return new ImmutableSet.Builder<IClient>().add(new BaseHandler()).add(layoutHandler).build();
  }
  ...
  @Test
  public void bootstrapServerInstallsNewLayout() throws Exception {
    Layout l = TestLayoutBuilder.single(SERVERS.PORT_0);
    assertThat(client.bootstrapLayout(l).get()).isEqualTo(true);

    assertThat(client.getLayout().get().asJSONString()).isEqualTo(l.asJSONString());
  }

  @Test
  public void cannotBootstrapServerTwice() throws Exception {
