...
/**
 * This class tests the side-effects of closing the client router on the thread pool it uses.
 *
 * <p>Created by Maithem on 2/28/20.
 */
public class NettyClientRouterTest {
  ...
  public void eventLoopCleanUpTest() {
    ...
    NettyClientRouter managedRouter =
    ...
    EventLoopGroup eventLoopGroup =
        ChannelImplementation.NIO
            ...
            .generate(
                numThreads,
                new ThreadFactoryBuilder().setDaemon(true).setNameFormat("netty1-%d").build());
