...
public abstract class AbstractServer {
  ...
  /**
   * A stub that handlers can override to manage their threading, otherwise the requests will be
   * executed on the IO threads
   *
   * @param msg
   * @param ctx
   * @param r
  ...
  /** The server state. Represents server in a particular state: READY, NOT_READY, SHUTDOWN. */
