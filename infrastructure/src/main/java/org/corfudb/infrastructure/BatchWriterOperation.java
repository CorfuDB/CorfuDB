...
/**
 * This container is used by the logunit to add work to the batch writer. Its also used to
...
public class BatchWriterOperation<T> {
  ...
  public static BatchWriterOperation<Void> SHUTDOWN =
      new BatchWriterOperation<>(Type.SHUTDOWN, null);
}
