...
public class CorfuServerCmdLine {
    ...
    public static final String USAGE =
            "Corfu Server, the server for the Corfu Infrastructure.\n"
                    ...
                    + "[[--file-watcher-poll-period=<file_watcher_poll_period>]]"
                    ...
                    + " --disable-file-watcher                                                   "
                    + "               Disable file watcher for the server.                     \n"
                    + " --file-watcher-poll-period=<poll_period>                                 "
                    + "              The period at which the file watcher will poll the file from"
                    + "              the disk (in seconds). Default 60.                          "
                    + " --base-server-threads=<base_server_threads>                              "
