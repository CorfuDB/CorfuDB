...
/**
 * Cluster State Context maintains shared context composing of cluster connectivity. Created by
 * zlokhandwala on 11/2/18.
 */
@Slf4j
@Builder
public class ClusterStateContext {
  ...
  @Getter @NonNull private final AtomicReference<ClusterState> clusterView;

  /**
   * Refreshes the cluster view based on the local endpoint and the snapshot epoch at which the node
   * states are updated.
   *
