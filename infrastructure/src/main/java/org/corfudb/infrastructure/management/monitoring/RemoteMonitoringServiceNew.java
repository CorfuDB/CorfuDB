 ...
 */
@Slf4j
public class RemoteMonitoringServiceNew implements ManagementService {
    ...
    public RemoteMonitoringServiceNew(@NonNull ServerContext serverContext,
    ...
    public void start(Duration monitoringInterval) {
        ...
        detectionTasksScheduler.scheduleAtFixedRate(
                () -> LambdaUtils.runSansThrow(() -> runDetectionTasksNew()),
                0,
     ...
     * @return task result
     */
    private synchronized CompletableFuture<DetectorTask> runDetectionTasksNew() {
