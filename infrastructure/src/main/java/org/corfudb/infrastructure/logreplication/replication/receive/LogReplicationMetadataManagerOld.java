 ...
 */
@Slf4j
public class LogReplicationMetadataManagerOld {
    ...
    public LogReplicationMetadataManagerOld(CorfuRuntime rt, long topologyConfigId, String localClusterId) {
        this.runtime = rt;
    ...
    public void updateSnapshotSyncStatusOngoing(String clusterId, boolean forced, UUID eventId,
        ...
        SnapshotSyncType syncType = forced ? SnapshotSyncType.FORCED : SnapshotSyncType.DEFAULT;
