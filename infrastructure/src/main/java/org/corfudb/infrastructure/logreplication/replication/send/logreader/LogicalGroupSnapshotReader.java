...
public class LogicalGroupSnapshotReader extends BaseSnapshotReader {
    ...
    /**
     * Flattened data structure of the field {@link LogReplicationLogicalGroupConfig#getRemovedGroupToStreams()} in
     * LogReplicationLogicalGroupConfig.
     */
    private Set<String> streamsToClear;

    private boolean isReadingStreamToClear;
     ...
     *
     * @param syncRequestId syncRequestId for the ongoing snapshot sync
     * @return LogReplication SNAPSHOT_MESSAGE
     */
    @Override
    ...
    LogReplication.LogReplicationEntryMsg generateClearMessage(String streamName, UUID snapshotRequestId) {
        ...
        LogReplication.LogReplicationEntryMetadataMsg metadata = LogReplication.LogReplicationEntryMetadataMsg
                .newBuilder()
