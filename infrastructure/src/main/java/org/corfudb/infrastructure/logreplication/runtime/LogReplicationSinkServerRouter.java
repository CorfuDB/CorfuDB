...
//    public LogReplicationSinkServerRouter(List<AbstractServer> servers) {
...
//        } else {
//            this.serverAdapter = getAdapter(((BaseServer) serverMap.get(BaseServer.class)).serverContext);
//        }
    }
