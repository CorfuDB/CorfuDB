 ...
 */
public class BaseSnapshotReader extends SnapshotReader {
    ...
    protected PriorityQueue<String> streamsToSend;
    ...
    protected final ReplicationSession replicationSession;

    /**
     * Init runtime and streams to read
     */
    public BaseSnapshotReader(CorfuRuntime runtime, LogReplicationConfigManager configManager,
        ...
        maxDataSizePerMsg = config.getMaxDataSizePerMsg();
        messageSizeDistributionSummary = configureMessageSizeDistributionSummary();
    ...
    protected void refreshStreamsToReplicateSet() {
        config = configManager.getUpdatedConfig(replicationSession.getSubscriber());
    }
