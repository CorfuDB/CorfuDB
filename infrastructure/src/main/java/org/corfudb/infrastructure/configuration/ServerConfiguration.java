...
public class ServerConfiguration extends PropertiesConfiguration {
    ...
    public ServerConfiguration setServerDirectory(String path) {
        ...
        if (!parentDir.isDirectory()) {
            throw new UnrecoverableCorfuError("Service directory " + path + " must be a directory!");
        }

        String corfuServerDir = parentDir.getAbsolutePath()
                + File.separator
                + "corfu";
        setProperty(SERVER_DIR, corfuServerDir);
        return this;
    }
