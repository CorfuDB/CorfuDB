...
/**
 * A definition of a workflow that heals an existing unresponsive node back to the cluster. NOTE:
 * The healing first resets this node, which erases all existing data. Then, similar to the
 * AddNodeWorkflow, the segment is split, the node is added with all the data transferred from the
 * existing log unit nodes and finally the segments are merged.
 *
