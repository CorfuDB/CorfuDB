...
/**
 * A definition of a workflow that merges all the segments in the layout. This workflow compares
 * every two consequent segments and restores the redundancy in all nodes present in both the
 * segments. After the state transfer, the workflow merges the segments. This is carried out for all
 * segments until the layout has only one segment left. Created by Zeeshan on 2019-02-06.
 */
@Slf4j
