 ...
 * multi-step operation. For example, adding a new node to the cluster, which requires several steps
 * to complete.
 *
...
public interface IWorkflow {
  ...
  default boolean completed() {
    return getActions().stream().allMatch(a -> a.getStatus().equals(ActionStatus.COMPLETED));
  }
}
