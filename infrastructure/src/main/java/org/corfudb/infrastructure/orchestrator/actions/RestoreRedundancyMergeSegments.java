...
public class RestoreRedundancyMergeSegments extends Action {
    ...
    @Getter
    private final int committedProcessorNumConsumers = 2;
    ...
    Optional<Long> tryGetCommittedTail(CorfuRuntime runtime) {
        try {
            ...
            log.warn("tryGetCommittedTail: failed to retrieve the committed tail. " +
    ...
    private long trimLog(CorfuRuntime runtime) throws TimeoutException {
        ...
        long trimMark = runtime.getAddressSpaceView().getTrimMark(false).getSequence();
    ...
    public void impl(@Nonnull CorfuRuntime runtime) throws Exception {
        ...
        ParallelTransferProcessor parallelTransferProcessor = new ParallelTransferProcessor
                (committedProcessorNumConsumers, committedBatchProcessor);
