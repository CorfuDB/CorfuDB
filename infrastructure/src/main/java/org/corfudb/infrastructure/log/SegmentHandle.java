...
class SegmentHandle {
  ...
  @NonNull final FileChannel writeChannel;

  @NonNull final FileChannel readChannel;
  ...
  public void close() {
    Set<FileChannel> channels = new HashSet<>(Arrays.asList(writeChannel, readChannel));
