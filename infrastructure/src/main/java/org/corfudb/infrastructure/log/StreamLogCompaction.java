...
/**
 * Scheduled log compaction manager. Execute log compaction safely (prevent scheduled executor
 * corruption if the task throws an exception)
...
public class StreamLogCompaction {
  ...
  private final ThreadFactory threadFactory =
      new ThreadFactoryBuilder().setDaemon(true).setNameFormat("LogUnit-Maintenance-%d").build();
