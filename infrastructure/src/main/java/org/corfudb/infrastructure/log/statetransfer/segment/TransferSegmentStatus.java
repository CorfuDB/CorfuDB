...
public class TransferSegmentStatus {
  /**
   * States of the segment: - {@link SegmentState#NOT_TRANSFERRED}: Segment is not transferred. -
   * {@link SegmentState#TRANSFERRED}: Segment was transferred fully. - {@link
   * SegmentState#RESTORED}: Segment was restored, and is present in the current layout. - {@link
   * SegmentState#FAILED}: The state transfer of a segment has failed.
   */
  ...
  @Builder.Default public final SegmentState segmentState = SegmentState.NOT_TRANSFERRED;
