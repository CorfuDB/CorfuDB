...
public interface StreamLog {
  ...
  /**
   * Append a range of consecutive entries ordered by their addresses. Entries that are trimmed, or
   * overwrites other addresses are ignored (i.e. they are not written) and an OverwriteException is
   * not thrown.
   *
   * @param entries
   */
