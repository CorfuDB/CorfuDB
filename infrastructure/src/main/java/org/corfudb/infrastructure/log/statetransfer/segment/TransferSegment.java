...
public class TransferSegment {
  ...
  /**
   * Given an optional committed tail, turn a current transfer segment into a transfer segment
   * range.
   *
        ...
        .map(
            tail -> {
              if (tail < startAddress) {
                ...
                TransferSegmentRangeSingle first =
                    TransferSegmentRangeSingle.builder()
                        .startAddress(startAddress)
                        .endAddress(tail)
                        .typeOfTransfer(CONSISTENT_READ)
                        .availableServers(Optional.of(ImmutableList.copyOf(getLogUnitServers())))
                ...
                TransferSegmentRangeSingle second =
                    TransferSegmentRangeSingle.builder()
                        .startAddress(tail + 1)
                        .endAddress(endAddress)
                        .typeOfTransfer(PROTOCOL_READ)
