...
public class CorfuServer {
    ...
    private static final String USAGE =
            "Corfu Server, the server for the Corfu Infrastructure.\n"
                    ...
                    + "[--metrics] [--metrics-port <metrics_port>] [--node-id=<nodeId>]"
                    + "[--snapshot-batch=<batch-size>] [--log-replication-config=<log-replication-config-file-path>]"
                    ...
                    + "              Path to a log replication config                   \n       "
                    + " --node-id=<nodeId>                                                       "
