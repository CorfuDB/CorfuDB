...
public class PaxosDataStore {
  ...
  public Optional<Rank> getPhase1Rank(long serverEpoch) {
    KvRecord<Rank> phase1Record =
        KvRecord.of(PREFIX_PHASE_1, serverEpoch + KEY_SUFFIX_PHASE_1, Rank.class);
  ...
  public Optional<Phase2Data> getPhase2Data(long serverEpoch) {
    KvRecord<Phase2Data> phase2Record =
        KvRecord.of(PREFIX_PHASE_2, serverEpoch + KEY_SUFFIX_PHASE_2, Phase2Data.class);
