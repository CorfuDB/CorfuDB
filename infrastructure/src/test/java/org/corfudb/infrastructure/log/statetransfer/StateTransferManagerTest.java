...
import org.corfudb.infrastructure.log.statetransfer.StateTransferManager.StateTransferType;
...
import org.corfudb.infrastructure.log.statetransfer.StateTransferManager.TransferSegmentRangeSingle;
import org.corfudb.infrastructure.log.statetransfer.StateTransferManager.TransferSegmentRangeSplit;
...
class StateTransferManagerTest implements TransferSegmentCreator {
    ...
    void testSingleNotTransferredRangeToSingleNotTransferredRange() {
        ...
        ImmutableList<TransferSegmentRange> ranges = ImmutableList.of(
                getSingleRange(0L, 1000L,
                        StateTransferType.CONSISTENT_READ,
                        false,
    ...
    void testGetUnknownAddressesInRangeTimeOutException() {
        ...
        assertThatThrownBy(() -> configuredInstance.getUnknownAddressesInRange(rangeStart, rangeEnd))
                .isInstanceOf(UnknownAddressInRangeException.class)
    ...
    void testGetUnknownAddressesInRangeNetworkException() {
        ...
        doAnswer(invoke -> {
            throw new NetworkException("localhost", NodeLocator.builder().host("localhost").build());
        }).when(client).requestKnownAddresses(rangeStart, rangeEnd);
    ...
    void testGetUnknownAddressesInRangeWrongEpochException() {
        ...
        doAnswer(invoke -> {
            throw new WrongEpochException(1L);
        }).when(client).requestKnownAddresses(rangeStart, rangeEnd);
    ...
    void createBatchWorkload() {
        ...
        Stream<TransferBatchRequest> consistentWorkload =
                spy.createBatchWorkload(ranges, StateTransferType.CONSISTENT_READ);
