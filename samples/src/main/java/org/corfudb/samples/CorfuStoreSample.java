...
/**
 * This is a sample application to create tables and write to Corfu. The Corfu Store requires the
 * key, value and metadata to be created as protobuf objects. This Sample creates a table with name
 * - "profile" in namespace - "credentials". The creates are done using the transaction builder
 * which displays how a transaction is begun and ended on the invocation of commit.
 *
 * <p>Created by zlokhandwala on 10/12/19.
 */
  ...
  public static void main(String[] args) throws Exception {
    ...
    */
    ...
    corfuStore.openTable(
        namespace, tableName, Name.class, Car.class, null, TableOptions.builder().build());
    ...
    CorfuRecord record =
        corfuStore
            .query(namespace)
            .getRecord(tableName, Name.newBuilder().setFirstName("a").setLastName("x").build());
