...
public class Result<T, E extends RuntimeException> implements Supplier<T> {
     ...
     *
     * @param other
     *            alternative value to return if instance encapsulates an error.
     *
     ...
     *
     * @param consumer
     *            action to perform if instance encapsulates a valid result.
     * @param action
     *            action to perform if instance encapsulates an empty value or an error.
     */
     ...
     *
     * @param function
     *            mapping function to apply to the internal result
     * @param <U>
