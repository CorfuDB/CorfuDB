...
public class IntervalRetry<
        E extends Exception, F extends Exception, G extends Exception, H extends Exception, O>
    extends AbstractRetry<E, F, G, H, O, IntervalRetry> {

  /** The interval, in milliseconds to wait for retry. */
  @Getter @Setter long retryInterval = 1000;
