...
public class PrimitiveSerializer implements ISerializer {
  ...
  static <T, R> void writeArray(T[] o, ByteBuf b, BiFunction<ByteBuf, R, ByteBuf> applyFunc) {
    ...
    b.writeInt(length);
    Arrays.stream(o).forEach(i -> applyFunc.apply(b, (R) i));
  }

  @SuppressWarnings("unchecked")
  static <T, R> T[] readArray(
      ByteBuf b, Function<ByteBuf, T> applyFunc, Function<Integer, T[]> arrayGen) {
  ...
  enum Primitives {
    ...
    BOOLEAN(
        4, Boolean.class, boolean.class, (o, b) -> b.writeBoolean(o), (b, r) -> b.readBoolean()),
    ...
    CORFU_SMR(
        ...
        (o, b) -> {
          ...
          try {
            ...
            log.trace("Serializing a SMRObject of type {} as a stream pointer to {}", smrClass, id);
    ...
    @Getter public final byte typeNum;
    @Getter public final Class<?> classType;
    @Getter public final Class<?> primitiveClass;
    @Getter public final SerializerFunction<?> serializer;
    @Getter public final DeserializerFunction deserializer;
