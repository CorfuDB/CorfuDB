...
/**
 * Utils for sleeping with or without interruptions using timeunits, much like {@link TimeUnit}'s
 * sleep functionality.
 *
 * <p>Use these methods rather than {@link Thread#sleep(long)} or {@link TimeUnit#sleep(long)}
...
public enum Sleep {
   ...
   *
   * <p>If sleep is interrupted, this method will throw {@link UnrecoverableCorfuInterruptedError},
   * which will indicate that Corfu was interrupted but cannot recover from the interruption.
   *
