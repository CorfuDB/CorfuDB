...
/**
 * Created by sneginhal on 01/31/2017. This ChannelDuplexHandler is inserted into the CorfuRuntime's
 * Netty pipeline. After TLS is negotiated and we have a secure channel, this handler sends the
 * username/password for authentication as per: https://tools.ietf.org/html/rfc4616
 */
@Slf4j
public class PlainTextSaslNettyClient extends ChannelDuplexHandler {
  ...
  public PlainTextSaslNettyClient(String username, String password) throws SaslException {
    PlainTextCallbackHandler cbh = new PlainTextCallbackHandler(username, password);
    saslClient = Sasl.createSaslClient(mechanisms, username, "plain", null, null, cbh);
  }
