...
/** Created by sneginhal on 02/01/2017. Utility for SASL options parsing. */
  ...
  public static PlainTextSaslNettyClient enableSaslPlainText(
    ...
    try {
      ...
      throw new RuntimeException(
          "Error reading the username file: " + e.getClass().getSimpleName(), e);
    }
    ...
    try {
      ...
      throw new RuntimeException(
          "Error reading the password file: " + e.getClass().getSimpleName(), e);
    }
    ...
    try {
      ...
      throw new RuntimeException(
          "Could not create a SASL Plain Text Netty client" + se.getClass().getSimpleName(), se);
    }
