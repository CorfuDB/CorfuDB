...
/**
 * Created by sneginhal on 01/27/2017. Implementation of the plain text SASL server provider. Please
...
public class PlainTextSaslServerProvider extends Provider {
  ...
  protected PlainTextSaslServerProvider() {
    super("PlainTextSaslServerProvider", 1.0, "Plain Text Sasl Server Provider for CorfuDB");
    super.put(
        "SaslServerFactory." + PlainTextSaslServer.MECHANISM,
