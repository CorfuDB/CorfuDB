...
/**
 * This trust manager reloads the trust store whenever a checkClientTrusted or checkServerTrusted is
 * called.
 *
 * <p>Created by zjohnny on 9/18/17.
 */
@Slf4j
public class ReloadableTrustManager implements X509TrustManager {
   ...
   */
  public ReloadableTrustManager(String trustStorePath, String trustPasswordPath)
      throws SSLException {
  ...
  private void reloadTrustStore() throws SSLException {
    ...
    try {
      ...
      String errorMessage =
          "No support for TrustManagerFactory default algorithm "
