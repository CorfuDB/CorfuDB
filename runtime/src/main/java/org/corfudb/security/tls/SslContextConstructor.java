...
public class SslContextConstructor {
  ...
  public static SslContext constructSslContext(
    ...
    ReloadableTrustManagerFactory tmf =
        new ReloadableTrustManagerFactory(trustStorePath, tsPasswordFile);
    ...
    if (OpenSsl.isAvailable()) {
      ...
      log.warn(
          "constructSslContext: couldn't load native openssl library, using JdkSslEngine instead!");
    }
  ...
  private static KeyManagerFactory createKeyManagerFactory(
      String keyStorePath, String ksPasswordFile) throws SSLException {
    ...
    try {
      ...
      String errorMessage =
          "Can not create key manager factory with default algorithm "
