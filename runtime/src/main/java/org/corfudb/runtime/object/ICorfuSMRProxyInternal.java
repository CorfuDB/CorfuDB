 ...
 *
 * <p>This interface contains methods which are used only by Corfu's object layer, and shouldn't be
 * exposed to other packages (such as the annotation processor).
 *
