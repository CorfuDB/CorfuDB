 ...
 * interface. Whatever guarantees are being provided the the underlying map implementation (such as
 * ordering, retrieval complexity...) are also provided by this map.
 *
 * @param <K> key type
 * @param <V> value type
 */
