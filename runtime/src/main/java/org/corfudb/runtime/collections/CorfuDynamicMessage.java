...
public class CorfuDynamicMessage {
  ...
  @Getter private final DynamicMessage payload;
  ...
  public boolean equals(Object obj) {
    ...
    // The getAllFields returns a {@link com.google.protobuf.SmallSortedMap}. This map ensures
    // ordering.
    // This is created internally in protobuf from 2 parts an entry list  which is an ArrayList and
    // an overflowMap
    // which is a TreeMap. Both of these guarantee ordering and hence ordering is guaranteed in the
    // iteration.
