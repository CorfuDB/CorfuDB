...
/**
 * Contains the key as {@link CorfuDynamicMessage} after extracting it from {@link
 * com.google.protobuf.Any}. This wrapper contains the payload and the respective typeUrl required
 * to populate the Any on serialization. This object is stored as the key in the CorfuTable while
...
public class CorfuDynamicKey {
  ...
  @Getter private final String keyTypeUrl;
  ...
  public boolean equals(Object obj) {
    ...
    return keyTypeUrl.equals(corfuDynamicKey.keyTypeUrl) && key.equals(corfuDynamicKey.key);
  }
}
