...
import static org.corfudb.protocols.service.CorfuProtocolSequencer.getStreamsAddressResponse;
...
public class SequencerHandler implements IClient, IHandler<SequencerClient> {
    ...
    private static Object handleStreamsAddressResponse(ResponseMsg msg,
                                                       ChannelHandlerContext ctx,
                                                       IClientRouter r) {
        return getStreamsAddressResponse(msg.getPayload().getStreamsAddressResponse());
    }
}
