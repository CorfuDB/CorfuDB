...
/**
 * This is a base client which handles basic Corfu messages such as PING, ACK. This is also
 * responsible for handling unknown server exceptions.
 *
...
public class BaseHandler implements IClient {
  ...
  @Getter @Setter public IClientRouter router;
  ...
  private static Object handleWrongEpoch(
  ...
  private static Object handleVersionResponse(
      JSONPayloadMsg<VersionInfo> msg, ChannelHandlerContext ctx, IClientRouter r) {
  ...
  private static Object handleServerException(
      CorfuPayloadMsg<ExceptionMsg> msg, ChannelHandlerContext ctx, IClientRouter r)
      throws Throwable {
    log.warn(
        "Server threw exception for request {}",
        msg.getRequestID(),
  ...
  private static Object handleWrongClusterId(
      CorfuPayloadMsg<WrongClusterMsg> msg, ChannelHandlerContext ctx, IClientRouter r) {
    WrongClusterMsg wrongClusterMessage = msg.getPayload();
    throw new WrongClusterException(
        wrongClusterMessage.getServerClusterId(), wrongClusterMessage.getClientClusterId());
  }
}
