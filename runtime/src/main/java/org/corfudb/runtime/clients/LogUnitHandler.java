...
public class LogUnitHandler implements IClient, IHandler<LogUnitClient> {
  ...
  @Setter @Getter IClientRouter router;
  ...
  public ClientMsgHandler msgHandler =
      new ClientMsgHandler(this).generateHandlers(MethodHandles.lookup(), this);
  ...
  private static Object handleOverwrite(
      CorfuPayloadMsg<Integer> msg, ChannelHandlerContext ctx, IClientRouter r) throws Exception {
  ...
  private static Object handleDataOutranked(
      CorfuMsg msg, ChannelHandlerContext ctx, IClientRouter r) throws Exception {
  ...
  private static Object handleValueAdoptedResponse(
      CorfuPayloadMsg<ReadResponse> msg, ChannelHandlerContext ctx, IClientRouter r) {
  ...
  private static Object handleReadResponse(
      CorfuPayloadMsg<ReadResponse> msg, ChannelHandlerContext ctx, IClientRouter r) {
  ...
  private static Object handleReadDataCorruption(
      CorfuPayloadMsg<Long> msg, ChannelHandlerContext ctx, IClientRouter r) {
    long read = msg.getPayload().longValue();
    throw new DataCorruptionException(
        String.format("Encountered corrupted data while reading %s", read));
  }
  ...
  private static Object handleInspectAddressResponse(
      CorfuPayloadMsg<InspectAddressesResponse> msg, ChannelHandlerContext ctx, IClientRouter r) {
    return msg.getPayload();
  }
  ...
  private static Object handleTailResponse(
      CorfuPayloadMsg<TailsResponse> msg, ChannelHandlerContext ctx, IClientRouter r) {
    return msg.getPayload();
  }
  ...
  private static Object handleStreamsAddressResponse(
      CorfuPayloadMsg<TailsResponse> msg, ChannelHandlerContext ctx, IClientRouter r) {
    return msg.getPayload();
  }
  ...
  private static Object handleTrimMarkResponse(
      CorfuPayloadMsg<Long> msg, ChannelHandlerContext ctx, IClientRouter r) {
    return msg.getPayload();
  }
  ...
  private static Object handleKnownAddressesResponse(
      CorfuPayloadMsg<KnownAddressResponse> msg, ChannelHandlerContext ctx, IClientRouter r) {
    return msg.getPayload();
  }
}
