...
public class LogUnitHandler implements IClient, IHandler<LogUnitClient> {
    ...
    /**
     * Handle a DATA_OUTRANKED_ERROR response from the server.
     *
     * @param msg The DATA_OUTRANKED_ERROR message
     * @param ctx The context the message was sent under
     * @param r   A reference to the router
     * @return none, throw a DataOutranked exception instead.
     */
    @ServerErrorsHandler(type = ErrorCase.DATA_OUTRANKED_ERROR)
    private static Object handleDataOutrankedError(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter r) {
     ...
     *
     * @param msg The VALUE_ADOPTED_ERROR message
     * @param ctx The context the message was sent under
     * @param r   A reference to the router
     * @return none, throw a ValueAdopted exception instead.
     */
    @ServerErrorsHandler(type = ErrorCase.VALUE_ADOPTED_ERROR)
    private static Object handleValueAdoptedError(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter r) {
        ReadResponse readResponse = getReadResponse(msg.getPayload().getServerError().getValueAdoptedError());
