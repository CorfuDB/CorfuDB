...
public class LogUnitHandler implements IClient, IHandler<LogUnitClient> {
    ...
    private static Object handleWriteLogResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
        return true;
    }
    ...
    private static Object handleRangeWriteLogResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
        return true;
    }
    ...
    private static Object handleReadLogResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleInspectResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleTrimLogResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
        return true;
    }
    ...
    private static Object handleTrimMarkResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleTailResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleCompactResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
        return true;
    }
    ...
    private static Object handleFlushCacheResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
        return true;
    }
    ...
    private static Object handleLogAddressSpaceResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleKnownAddressResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleCommittedTailResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleUpdateCommittedTailResponse(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
        return true;
    }
    ...
    private static Object handleTrimmedError(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleOverwriteError(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
    ...
    private static Object handleDataCorruptionError(ResponseMsg msg, ChannelHandlerContext ctx, IClientRouter router) {
