...
public class ClientMsgHandler {
   ...
   */
  public <T extends CorfuMsg> ClientMsgHandler addHandler(
      CorfuMsgType messageType, ClientMsgHandler.Handler<T> handler) {
   ...
   */
  public ClientMsgHandler generateHandlers(
      @NonNull final MethodHandles.Lookup caller, @NonNull final Object o) {
                      ...
                      (ClientMsgHandler.Handler)
                          LambdaMetafactory.metafactory(
                                  ...
                                  MethodType.methodType(
                                      ClientMsgHandler.Handler.class, o.getClass()),
