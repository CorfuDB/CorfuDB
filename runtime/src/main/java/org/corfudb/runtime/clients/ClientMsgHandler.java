                ...
                .forEach(x -> {
                    ...
                    try {
                        if (Modifier.isStatic(x.getModifiers())) {
                            ...
                            handlerMap.put(a.type(), (ClientMsgHandler.Handler) LambdaMetafactory.metafactory(caller,
                                    "handle", MethodType.methodType(ClientMsgHandler.Handler.class),
                                    mt, mh, mh.type())
                            ...
                            handlerMap.put(a.type(), (ClientMsgHandler.Handler) LambdaMetafactory.metafactory(caller,
                                    "handle", MethodType.methodType(ClientMsgHandler.Handler.class, o.getClass()),
