...
public class ClusterStatusReport {
  ...
  public enum NodeStatus {
    ...
    /**
     * Whenever the state of a node cannot be determined. If a client looses connection to all nodes
     * it is wrong to report them DOWN, nodes might be up and clients are unable to connect.
     */
    NA;
  }
  ...
  public enum ClusterStatus {
    ...
    /**
     * The cluster is operational but one or several nodes are syncing in the background. i.e.,
     * (replica catch up)
     */
    DB_SYNCING(1),
    ...
    @Getter private final int healthValue;
  ...
  /**
   * Represents the sources for cluster status computation. This aims to provide an indicative of
   * status reliability.
   */
  public enum ClusterStatusReliability {
    ...
    /**
     * Unavailable, whenever communication fails to ALL nodes, the source of reliability is not
     * available.
     */
    UNAVAILABLE
  }
  ...
  /** Cluster health. */
  @NonNull private final ClusterStatus clusterStatus;

  /** Cluster Status Reliability (source of information) */
  @NonNull private final ClusterStatusReliability clusterStatusReliability;

  /** Individual Node Status (within cluster view). */
  @NonNull private final Map<String, NodeStatus> clusterNodeStatusMap;

  /** Map of connectivity of the client to the each cluster node. */
  @NonNull private final Map<String, ConnectivityStatus> clientServerConnectivityStatusMap;
}
