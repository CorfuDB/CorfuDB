...
/**
 * Currently, this class holds static constants used to represent addresses. In the future, it may
 * replace the use of long depending on performance.
 *
...
public class Address {
   ...
   */
  @Getter private static long minAddress = 0L;
  ...
  /**
   * Aborted request constant. Used to indicate an attempted read, but was rejected at the request
   * of the client.
   */
  public static final long ABORTED = -2L;

  /** Not found constant. Used to indicate that a search for an entry did not result in a entry. */
  public static final long NOT_FOUND = -3L;

  /** Optimistic constant. Used to indicate that an update is optimistic. */
  ...
  /**
   * A non-existing address constant. Indicating that an address was request, but no match exists.
   */
  public static final long NON_EXIST = -6L;

  /**
   * This is a constant use for initializing addresses before 0 is read. to be consistent, a initial
   * position already "consumed" is -1L
   */
