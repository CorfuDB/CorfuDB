...
public class ConservativeFailureHandlerPolicy implements IReconfigurationHandlerPolicy {
  ...
  /**
   * Modifies the layout by marking the failed nodes as unresponsive but still keeping them in the
   * layout and sequencer servers lists. Removes these failed nodes from the log unit segments.
   *
