...
public interface IHoleFillPolicy {
  ...
  /**
   * Apply the given peek function until hole filling is required or committed data is returned. If
   * hole filling is required a HoleFillRequiredException is thrown.
   *
   * @param address The address to apply the function.
   * @param peekFunction The function to use to peek data from the log.
