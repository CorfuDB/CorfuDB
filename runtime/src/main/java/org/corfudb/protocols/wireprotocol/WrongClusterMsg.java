...
/**
 * A message sent from the server router to the client in response to the client sending an original
 * message stamped with a clusterId that is different from the server's clusterId.
 */
@Builder
@AllArgsConstructor
@Getter
