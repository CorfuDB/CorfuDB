...
/**
 * An interface to log data entries. Log data entries represent data stored in the actual log, with
 * convenience methods for software to retrieve the stored information.
 *
 * <p>Created by mwei on 8/17/16.
 */
public interface ILogData extends IMetadata, Comparable<ILogData> {
  ...
  /**
   * This class provides a serialization handle, which manages the lifetime of the serialized copy
   * of this entry.
   */
  class SerializationHandle implements AutoCloseable {
    ...
    /**
     * Explicitly request the serialized form of this log data which only exists for the lifetime of
     * this handle.
     *
