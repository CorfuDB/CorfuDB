...
/**
 * Full information about failure that changed cluster state. It can be saved in history and provide
 * full information about a cluster and a failure. The decision made by a node can be reproduced
