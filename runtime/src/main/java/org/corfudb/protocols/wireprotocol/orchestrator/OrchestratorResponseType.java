 ...
 *
 * <p>Created by Maithem on 1/2/18.
 */
@AllArgsConstructor
public enum OrchestratorResponseType {
  ...
  @Getter public final int type;

  @Getter final Function<byte[], Response> responseGenerator;
  ...
  static final Map<Integer, OrchestratorResponseType> typeMap =
      Arrays.stream(OrchestratorResponseType.values())
          .collect(
              Collectors.toMap(
                  OrchestratorResponseType::getType, java.util.function.Function.identity()));
}
