...
public class HandshakeState {
  ...
  /**
   * Indicates if the handshake has failed. - If it fails because of validation, handshakeComplete =
   * true. - If it fails due to timeout, handshakeComplete = False.
   */
   ...
   *
   * @return true, if handshake completed. false, if handshake never concluded.
   */
