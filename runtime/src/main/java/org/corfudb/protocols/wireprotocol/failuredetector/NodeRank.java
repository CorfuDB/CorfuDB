...
/**
 * The rank of the node in a graph. Sorting nodes according to rank used to search for decision
 * makers, failed nodes and so on. Sorting according to: - Descending order of number of connections
