...
/**
 * Represent a Netty handler in charge of applying filters on the inbound Corfu messages in order to
 * transform them. The transformation are supplied to this handler as a {@link List} of {@link
 * MsgHandlingFilter}s which will be applied in order. An example of such transforming filters is
 * drop certain messages.
 *
 * <p>Created by Sam Behnam on 5/18/18.
 */
@Slf4j
public class InboundMsgFilterHandler extends ChannelDuplexHandler {
  ...
  public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
    ...
    log.info(
        "Applied {} filtering rule(s) on the inbound message. "
  ...
  /**
   * This method applies the collection of filters on the provided message and return a list of
   * transformed messages
   *
   * @param corfuMsg initial {@link CorfuMsg} to be transformed by filters
   * @return a {@link List} of {@link CorfuMsg}s generated by transforming input message.
   */
