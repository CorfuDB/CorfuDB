 ...
 *
 * <p>Clients must obtain a token to write to the log using the normal writing protocol.
 *
 * <p>Created by mwei on 4/14/17.
 */
public interface IToken {
   ...
   *
   * @return A map of backpointers for the streams in the log. Also represents the streams this
   *     token is valid for.
   */
