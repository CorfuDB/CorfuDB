...
public enum CorfuMsgType {
    ...
    LOG_REPLICATION_ENTRY(201, new TypeToken<CorfuPayloadMsg<LogReplicationEntry>>() {}, true),
    LOG_REPLICATION_NEGOTIATION_REQUEST(202, TypeToken.of(CorfuMsg.class)),
    LOG_REPLICATION_NEGOTIATION_RESPONSE(203, new TypeToken<CorfuPayloadMsg<LogReplicationNegotiationResponse>>() {}, true),

    LOG_REPLICATION_QUERY_LEADERSHIP(204, TypeToken.of(CorfuMsg.class)),
    LOG_REPLICATION_QUERY_LEADERSHIP_RESPONSE(205, new TypeToken<CorfuPayloadMsg<LogReplicationQueryLeaderShipResponse>>(){}, true),
    ;
