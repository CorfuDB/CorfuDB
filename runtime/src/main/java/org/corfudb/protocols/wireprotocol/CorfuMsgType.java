...
public enum CorfuMsgType {
  ...
  SEQUENCER_METRICS_RESPONSE(
      25, new TypeToken<CorfuPayloadMsg<SequencerMetrics>>() {}, true, false),
  ...
  FAILURE_DETECTOR_METRICS_RESPONSE(
      85, new TypeToken<CorfuPayloadMsg<NodeState>>() {}, true, false),
  ...
  private MessageConstructor<? extends CorfuMsg> resolveConstructor() {
    ...
    try {
      ...
      try {
        return (MessageConstructor<? extends CorfuMsg>)
