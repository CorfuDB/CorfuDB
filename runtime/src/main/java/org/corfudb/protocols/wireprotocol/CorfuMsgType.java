...
public enum CorfuMsgType {
    ...
    MULTIPLE_GARBAGE_WRITE(37, new TypeToken<CorfuPayloadMsg<MultipleWriteMsg>>() {}),
    LOG_RECOVERY_STATES_REQUEST(38, new TypeToken<CorfuPayloadMsg<MultipleReadRequest>>() {}),
    LOG_RECOVERY_STATES_RESPONSE(39, new TypeToken<CorfuPayloadMsg<LogRecoveryStateResponse>>() {}),
    LOG_RECOVERY_STATES_WRITE(40, new TypeToken<CorfuPayloadMsg<LogRecoveryStateWriteMsg>>() {}),
