...
public class JSONPayloadMsg<T> extends CorfuMsg {
  ...
  /**
   * Get the payload. Uses some type reflection voodoo in order to get the type to the JSON parser,
   * so make sure to correctly parameterize this class, using with a raw type will most definitely
   * fail.
   *
