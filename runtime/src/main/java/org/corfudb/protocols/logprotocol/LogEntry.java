...
public class LogEntry implements ICorfuSerializable {
  ...
  /** The runtime to use. */
  @Setter protected CorfuRuntime runtime;

  /** The type of log entry. */
  @Getter LogEntryType type;

  /** The global address of this log entry. */
  @Getter @Setter long globalAddress = Address.NON_ADDRESS;
  ...
  /**
   * The base LogEntry format is very simple. The first byte represents the type of entry, and the
   * rest of the format is dependent on the the entry type.
   *
